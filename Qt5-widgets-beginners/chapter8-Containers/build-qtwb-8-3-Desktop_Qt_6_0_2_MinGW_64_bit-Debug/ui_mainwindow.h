...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        page->setGeometry(QRect(0, 0, 620, 247));
        toolBox->addItem(page, QString::fromUtf8("Page 1"));
        page_2 = new QWidget();
        page_2->setObjectName(QString::fromUtf8("page_2"));
        page_2->setGeometry(QRect(0, 0, 620, 247));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        toolBox->setItemText(toolBox->indexOf(page_3), QCoreApplication::translate("MainWindow", "Page", nullptr));
