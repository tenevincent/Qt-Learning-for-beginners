...
{
    QMdiSubWindow *midSubWindow = new QMdiSubWindow(this);
    QPlainTextEdit *editor = new QPlainTextEdit(midSubWindow);

    midSubWindow->setWidget(editor);
    midSubWindow->setAttribute(Qt::WA_DeleteOnClose);

    ui->mdiArea->addSubWindow(midSubWindow);
    midSubWindow->show();
